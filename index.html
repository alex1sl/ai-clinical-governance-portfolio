...
<head>
    ...
    <title>Alexis Smith | Clinical AI Governance Portfolio</title>
    <style>
        body { 
...
<body>
    ...
    <header>
        <h1>Alexis Smith</h1>
        <p style="font-size: 1.2rem; margin-top: 10px; color: #fff;">
            Clinical AI Governance | Nurse Practitioner | Healthcare Quality & Safety
        </p>
    </header>

    <div class="container">
        
        <div class="section" style="border-left: 10px solid #4682b4;">
            <h2>Portfolio Executive Summary: NIST RMF 1.0 Implementation</h2>
